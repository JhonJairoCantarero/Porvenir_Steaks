...
import com.example.home.Admin.ActivityMenuAdmin;
...
public class AdminPerfilFragment extends Fragment {
    ...
    ImageView imgPrev;
    CardView cardView;
    public static final int fragment_admin_perfil = 1300012;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        limpiar.animate().alpha(1).translationY(0).setDuration(1000).setStartDelay(500);
        return root;
    }
